<template>
  <header class="bg-green-400 border-b ">
    <div class="flex justify-around w-full bg-teal p-4">
      <router-link to="/" class="cursor-pointer font-semibold text-xl tracking-tight text-white">
        Employees Review
      </router-link>
